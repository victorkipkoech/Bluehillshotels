          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php echo "Administrator"; ?> - <?php echo "admin@gmail.com"; ?>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <a href="#"><i class="fa fa-circle text-success"></i> <?php echo "admin@gmail.com"; ?></a>
        </div>
      </div>
      <!-- search form -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="addroom.php"><i class="fa fa-home"></i> Rooms</a></li>
            <li><a href="#services"><i class="fa fa-circle-o"></i> Normal</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/layout/top-nav.php"><i class="fa fa-circle-o"></i> Type</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="pages/tables/data.html"><i class="fa fa-circle-o"></i> Term Papers</a></li>
          </ul>
        </li>
        <li>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body">
               <form action="hotelrooms.php" method="post">
                <button class="btn btn-success" type="submit"><span class="fa fa-home"></span> Add Rooms</button>
             <div class="form-group">
               ...
               <option>Business Deluxe Rooms</option>
               <option>Business Suite Rooms</option>
               </select>
             </div>
             <div class="form-group">
             ...
             <div class="box box-solid">
            <button class="btn btn-success pull-right"><span class="fa fa-home"></span> Add Rooms</button>
          </div>
           </form>
           ...
           <a href="viewrooms.php" class="btn btn-primary pull-left"><span class="fa fa-home"></span> View Rooms</a>
          </div>
        </div>
      <!-- /.row -->
    </section>
