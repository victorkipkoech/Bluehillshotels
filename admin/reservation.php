     ...
     <div class="panel-body">
         ...
         <!-- <div class="col-sm-3">
           <form >
             ...
             <div class="form-group">
               ...
               <input type="text" name="id" class="form-control" placeholder="Customer Id No">
             </div>
             <div class="form-group">
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="box box-solid">
            ...
            <div class="box-body">
             ...
             <div class="form-group">
               ...
               <input type="date" name="id" class="form-control" placeholder="Customer Id No">
             </div>
             <div class="form-group">
          ...
          <!-- /. box -->
          <div class="box box-solid">
            <button class="btn btn-success pull-right">List Available Rooms <span class="fa fa-angle-double-right"></span></button>
          </div>
        </div>
        <!-- /.col -->
        <div class="col-md-9">
